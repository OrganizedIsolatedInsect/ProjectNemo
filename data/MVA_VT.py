...
file = os.path.expanduser('~\\Documents\\Working Codes\MVA\MVA_VT2022.xml')
...
# Remove "section" in Provision field
mvavt['provision'] = mvavt['provision'].str.replace('section ', '')

# Add ID idnex for JSON
mvavt = mvavt.reset_index()

# Export
newfile = os.path.expanduser('~\\Documents\\Working Codes\MVA\mvavt_records.json')

mvavt.to_json(newfile, orient='records')

# =============================================================================
# MVA
# =============================================================================
file = os.path.expanduser('~\\Documents\\Working Codes\MVA\MVA.xml')
